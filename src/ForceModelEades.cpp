...
Vec2 ForceModelEades::atractiveForce(const Node &a, const Node &b) const {
...
Vec2 ForceModelEades::repulsiveForce(const Node &a, const Node &b) const {
...
Vec2 ForceModelEades::totalForce(const Node &a) const {
  float min = 1.0f;
  Vec2 total = {0.0, 0.0};
